...
const SetBar = ({ setInfo, removeSet, index }) => {
    const [weight, setWeight] = useState(setInfo.weight || null);
    const [reps, setReps] = useState(setInfo.reps || null);
    console.log(index);
    function submitSet() {
        console.log("SUBMIT");
    }
